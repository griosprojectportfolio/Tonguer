...
class CourseDetailViewController: UIViewController,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate {
  
  var flag: NSString! = "nill"
  ...
  override func viewDidLoad() {
    ...
    dict1 = NSDictionary(objects: ["Class Name","1000","0"], forKeys: ["coursename","courserate","id"])
    dict2 = NSDictionary(objects: ["course.png","Arrange","12XXXXXX","1"], forKeys: ["image","tilte","data","id"])
    dict3 = NSDictionary(objects: ["userred.png","Suitable for user","12XXXXXX","2"], forKeys: ["image","tilte","data","id"])
    dict4 = NSDictionary(objects: ["target.png","Target for","12XXXXXX","3"], forKeys: ["image","tilte","data","id"])
  ...
  func defaultUIDesign(){
    ...
    btnCourselist.setTitle("Course list", forState: UIControlState.Normal)
    btnCourselist.tag = 2
    ...
    btnCourseask.setTitle("Course asking", forState: UIControlState.Normal)
    btnCourseask.tag = 3
    ...
    if(flag.isEqualToString("PicupCourse")){
  ...
  func setVwFooterBtnsCallTryClass(){
    ...
    btnHaveClass.setTitle("Have class", forState: UIControlState.Normal)
