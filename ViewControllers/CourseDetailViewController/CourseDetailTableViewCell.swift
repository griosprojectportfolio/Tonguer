  ...
  func defaultCellContentForCourseDetail (dict : NSDictionary ,btnIndex:Int,frame:CGRect){
    ...
    case 1:
      ...
      case "0":
        ...
        lblclassname.text = dict.objectForKey("coursename") as? String
        ...
        lblrate.text = dict.objectForKey("courserate") as? String
      ...
      case "1","2","3":
        ...
        lblTitle.text = dict.objectForKey("tilte") as? String
        ...
        lblData.text = dict.objectForKey("data") as? String
