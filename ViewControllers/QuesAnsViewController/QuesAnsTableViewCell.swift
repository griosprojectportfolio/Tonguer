...
class QuesAnsTableViewCell: BaseTableViewCell {
  ...
  func defaultUIDesign(){
    ...
    if(isiPhone5orLower){
      ...
      celllbltext = UILabel(frame: CGRectMake(cellLine.frame.origin.x+10,5,celltxtVw.frame.width-70,celltxtVw.frame.height-20));
  ...
  func setContentProperties(){
    ...
    celllbltext.text = "This is a preliminary document for an API or technology in development. Apple is supplying."
    ...
    cellbtnAns.setTitle("45 Answer", forState: UIControlState.Normal)
